...
const productImage = (url: string) => url;

const products = [
  {
    name: 'Painless Night GLU',
    category: 'Bienestar diario',
    image: productImage('https://parchesonemore.com/wp-content/uploads/2024/12/6t-600x845.jpg'),
    description: 'Producto One More para presentar dentro de una rutina de bienestar y acompañamiento personalizado.',
  },
  {
    name: 'Slim Style',
    category: 'Estilo de vida',
    image: productImage('https://parchesonemore.com/wp-content/uploads/2024/12/bannerslimstyle-600x845.png'),
  ...
  },
  {
    ...
    image: productImage('https://parchesonemore.com/wp-content/uploads/2024/12/10k-600x845.jpg'),
  ...
  },
  {
    ...
    image: productImage('https://parchesonemore.com/wp-content/uploads/2024/12/14u-600x845.jpg'),
  ...
  },
  {
    ...
    image: productImage('https://parchesonemore.com/wp-content/uploads/2024/12/13y-600x845.jpg'),
  ...
  },
  {
    ...
    image: productImage('https://parchesonemore.com/wp-content/uploads/2024/12/12y-600x845.jpg'),
    description: 'Comunicación enfocada en hábitos, descanso responsable y acompañamiento informativo.',
  },
  {
    name: 'Night Gentlemen',
    category: 'Cuidado personal',
    image: productImage('https://parchesonemore.com/wp-content/uploads/2024/12/8l-600x845.jpg'),
    description: 'Producto de cuidado personal presentado con tono elegante, sobrio y profesional.',
  },
  {
    name: 'Night Ladies',
    category: 'Cuidado personal',
    image: productImage('https://parchesonemore.com/wp-content/uploads/2024/12/9g-600x845.jpg'),
    description: 'Línea de cuidado personal con estética premium y mensaje responsable.',
  },
  {
    name: 'GlutaNAD+ Boost',
    category: 'Innovación One More',
    image: productImage('https://parchesonemore.com/wp-content/uploads/2025/10/glutanad-onemore-600x900.png'),
    description: 'Producto destacado para reforzar el concepto de innovación, tecnología y bienestar.',
  },
  {
    name: 'Sonrie Collagen Patch',
    category: 'Cuidado premium',
    image: productImage('https://parchesonemore.com/wp-content/uploads/2024/12/Sornie-600x845.jpg'),
    description: 'Producto visual de cuidado premium para integrar a una experiencia elegante de marca.',
  },
  {
    name: 'Face Lifting Mask by Lumiere',
    category: 'Cuidado facial',
    image: productImage('https://parchesonemore.com/wp-content/uploads/2025/11/Face-lifting-mask-600x845.jpg'),
    description: 'Mascarilla facial premium para presentar cuidado personal con estética limpia y sofisticada.',
  },
];

const marqueeItems = products.map((product) => product.name);
const getProduct = (name: string) => products.find((product) => product.name === name) || products[0];
...
const projects = [
  {
    ...
    images: [getProduct('Painless Night GLU'), getProduct('Slim Style'), getProduct('Omevia')],
  },
  {
    number: '02',
    name: 'Rutina activa',
    ...
    images: [getProduct('B12 Plus'), getProduct('Dekamin'), getProduct('Melatonin Plus')],
  },
  {
    number: '03',
    ...
    description:
      'Presentación sobria para Night Gentlemen, Night Ladies y GlutaNAD+ Boost, manteniendo un enfoque de marca premium y conversación directa.',
    chips: ['Night Gentlemen', 'Night Ladies', 'GlutaNAD+ Boost'],
    images: [getProduct('Night Gentlemen'), getProduct('Night Ladies'), getProduct('GlutaNAD+ Boost')],
  },
  {
    number: '04',
    ...
    description:
      'Bloque final con Sonrie Collagen Patch y Face Lifting Mask by Lumiere, más llamada directa a WhatsApp para ampliar información.',
    chips: ['Sonrie Collagen Patch', 'Face Lifting Mask', 'WhatsApp'],
    images: [getProduct('Sonrie Collagen Patch'), getProduct('Face Lifting Mask by Lumiere'), getProduct('GlutaNAD+ Boost')],
  },
];
  ...
  return (
    <div className="relative mx-auto aspect-square w-[280px] sm:w-[360px] md:w-[440px] lg:w-[520px]">
      ...
      <div className="absolute left-[8%] top-[22%] h-[52%] w-[38%] rotate-[-8deg] overflow-hidden rounded-[2rem] border-2 border-white/40 bg-white shadow-2xl">
        <img src={getProduct('Painless Night GLU').image} alt="Painless Night GLU One More" className="h-full w-full object-cover" />
      </div>
      <div className="absolute left-[34%] top-[8%] z-10 h-[62%] w-[42%] rotate-[4deg] overflow-hidden rounded-[2rem] border-2 border-white/50 bg-white shadow-2xl">
        <img src={getProduct('GlutaNAD+ Boost').image} alt="GlutaNAD+ Boost One More" className="h-full w-full object-cover" />
      </div>
      <div className="absolute bottom-[8%] right-[4%] h-[46%] w-[36%] rotate-[10deg] overflow-hidden rounded-[2rem] border-2 border-white/40 bg-white shadow-2xl">
        <img src={getProduct('Slim Style').image} alt="Slim Style One More" className="h-full w-full object-cover" />
      </div>
...
function AboutSection() {
  const aboutText =
    'Soy José Lugo, distribuidor de One More. Esta landing presenta únicamente productos One More extraídos desde parchesonemore.com, sin listas de precios y sin testimonios. El objetivo es despertar curiosidad, educar con responsabilidad y llevar al interesado a WhatsApp para recibir orientación.';
